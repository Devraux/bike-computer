...
void bmp280_init(); //bmp primary initialization
void bmp280_read_raw(int32_t *temp, int32_t *pressure); //
void bmp280_reset();
int32_t bmp280_convert(int32_t temp, struct bmp280_calib_param *params);
int32_t bmp280_convert_temp(int32_t temp, struct bmp280_calib_param *params);
int32_t bmp280_convert_pressure(int32_t pressure, int32_t temp, struct bmp280_calib_param *params);
void bmp280_get_calib_params(struct bmp280_calib_param *params); //return bmp280 calibrate parameters
float bmp280_altitude(int32_t pressure); 
void bmp_init(); //bmp and I2C initialization
